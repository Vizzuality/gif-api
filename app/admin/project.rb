...
ActiveAdmin.register Project do
  ...
  form do |f|
    ...
    f.inputs do
      ...
      li do
        render partial: "admin/project/locations", locals: {coordinates: f.object.locations_projects.select(:latitude, :longitude).map{|l| {lat: l.latitude, lng: l.longitude}}.to_json}
      end
